            ...
            <div className="under-construction-container">
                ...
                <div className="gradient__text">
                    ...
                    <p className="p-notify">
                        Zapisz się na testy naszej aplikacji już 30 września! Otrzymaj 7 dni darmowego dostępu do wszystkich funkcji, a potem <strong className="notify-strong">20%</strong> zniżki na wersję premium. Podaj swój e-mail i dołącz do grona testerów!
                    </p>
                </div>
